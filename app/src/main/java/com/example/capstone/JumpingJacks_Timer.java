...
public class JumpingJacks_Timer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        videoView.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.jumpingjacksvideotest);
        ...
        myImageHomeButton = findViewById(R.id.imageHomeButton5);
        myImageHomeButton.setOnClickListener(v -> {
            mCountDownTimer.cancel();
            mCountDownTimer = null;
            Intent intent= new Intent(JumpingJacks_Timer.this, ExerciseList.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK|Intent.FLAG_ACTIVITY_NEW_TASK);
            startActivity(intent);
            finish();
        });

        myInfoButton = findViewById(R.id.infobutton5);
        myInfoButton.setOnClickListener(v -> {
            mCountDownTimer.cancel();
            mCountDownTimer = null;
            Intent intent= new Intent(JumpingJacks_Timer.this, JumpingJacksDescription.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK|Intent.FLAG_ACTIVITY_NEW_TASK);
            startActivity(intent);
            finish();
        });
