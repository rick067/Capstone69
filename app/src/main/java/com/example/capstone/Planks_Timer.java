...
public class Planks_Timer extends AppCompatActivity {
    ImageView img;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_planks_timer);
        ...
        myImageHomeButton.setOnClickListener(v -> {
            ...
            Intent intent= new Intent(Planks_Timer.this, ExerciseList.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK|Intent.FLAG_ACTIVITY_NEW_TASK);
            startActivity(intent);
            finish();
        });

        myInfoButton = findViewById(R.id.infobutton7);
        myInfoButton.setOnClickListener(v -> {
            mCountDownTimer.cancel();
            mCountDownTimer = null;
            Intent intent= new Intent(Planks_Timer.this, PlanksDescription.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK|Intent.FLAG_ACTIVITY_NEW_TASK);
            startActivity(intent);
            finish();
        });
        ...
        img.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                MediaPlayer mp = MediaPlayer.create(Planks_Timer.this,R.raw.planks);
                mp.start();
                return false;
            }
        });
