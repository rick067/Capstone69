...
public class Pushup_Timer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myImageHomeButton.setOnClickListener(v -> {
            ...
            Intent intent= new Intent(Pushup_Timer.this, ExerciseList.class);
        ...
        img.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                MediaPlayer mp = MediaPlayer.create(Pushup_Timer.this,R.raw.pushup);
                mp.start();
                return false;
            }
        });
