...
public class SideReach_Timer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myImageHomeButton.setOnClickListener(v -> {
            ...
            Intent intent= new Intent(SideReach_Timer.this, ExerciseList.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK|Intent.FLAG_ACTIVITY_NEW_TASK);
            startActivity(intent);
            finish();
        });

        myInfoButton = findViewById(R.id.infobutton10);
        myInfoButton.setOnClickListener(v -> {
            mCountDownTimer.cancel();
            mCountDownTimer = null;
            Intent intent= new Intent(SideReach_Timer.this, SideReachDescription.class);
            intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK|Intent.FLAG_ACTIVITY_NEW_TASK);
            startActivity(intent);
            finish();
        });
