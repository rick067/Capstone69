...
public class Squats_Timer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myImageHomeButton = findViewById(R.id.imageHomeButton11);
        myImageHomeButton.setOnClickListener(v -> {
            mCountDownTimer.cancel();
            mCountDownTimer = null;
            Intent intent= new Intent(Squats_Timer.this, ExerciseList.class);
