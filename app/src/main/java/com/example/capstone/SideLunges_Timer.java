...
public class SideLunges_Timer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_side_lunges_timer);
        ...
        myImageHomeButton = findViewById(R.id.imageHomeButton9);
        ...
        img.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                MediaPlayer mp = MediaPlayer.create(SideLunges_Timer.this,R.raw.sidelunges);
                mp.start();
                return false;
            }
        });
