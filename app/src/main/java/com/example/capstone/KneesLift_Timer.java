...
public class KneesLift_Timer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_knees_lift_timer);
...
//get timer data
        ...
        videoView.setVideoPath("android.resource://"+getPackageName()+"/"+R.raw.kneesliftmergevideotest);
        ...
        myImageHomeButton.setOnClickListener(v -> {
            ...
            Intent intent= new Intent(KneesLift_Timer.this, ExerciseList.class);
        ...
        img.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                MediaPlayer mp = MediaPlayer.create(KneesLift_Timer.this,R.raw.kneeslift);
                mp.start();
                return false;
            }
        });
